...
| **06** | PE & DVT | 21-24 | 謝慕揚、林彥良 | _本次 commit_ | ✅ 完成 |
...
依**建議優先順序**列出。第二部分已完成（03 + 06），下次可依興趣順序推進：

| 順序 | 模組 | 主題 | 教案 | 原作者 | 備註 |
|:----:|:----:|------|:----:|--------|------|
| 1 | **04** | 休克 | 13-16 | 陳麒心？ | RUSH protocol，**需確認 active 醫師** |
| 2 | **05** | 心跳停止 | 17-20 | （待確認） | US-CAB / 5H5T，**需確認 active 醫師** |
| 3 | **07** | 急性腹痛 | 25-28 | （待確認） | 多系統評估、FAST、AAA、cholecystitis |
| 4 | **08** | 呼吸喘 | 29-32 | （待確認） | BLUE Protocol 進階、肺 5 大徵象 |
| 5 | **09** | 肺炎與 ARF | 33-36 | （待確認） | LUS Score、橫膈評估、ARDS 整合 |
